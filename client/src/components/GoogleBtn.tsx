 ...
 */
const CLIENT_ID =
  "840194914617-c2ilgpenlc2aml6n9cckpuitv0grq9ft.apps.googleusercontent.com";

class GoogleBtn extends Component<
  {},
  { isLogined: boolean; userName: string }
> {
  ...
  render() {
    //this is what is rendered (what users see) in the react web app pahge
    return (
      <div>
